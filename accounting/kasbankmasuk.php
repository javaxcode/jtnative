<html>
 ...
 <body>
  <div class="container">
   <h1 align="center">KAS BANK MASUK</h1>
   <div align="right">
      <form method="POST" action="fetchkbm.php">
      <select name="bulan">
          <option value="01">Januari</option>
          <option value="02">Febuari</option>
      </select>
      <button type="submit" name="tampilkan" id="tampilkan" class="btn btn-info">Tampilkan</button>
      </form>
    </div>
    <div align="left">
  ...
  $.ajax({
   ...
   success:function(data)
   {
    ...
    for(var count=0; count<data.length; count++)
    {
     ...
     html_data += '<td data-name="input" class="input" data-type="text" style="text-align:right" data-pk="'+data[count].id+'">'+data[count].input+'</td></tr>';
     $('#employee_data').append(html_data);
    }
   }
  })
