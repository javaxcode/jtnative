...
require '../controllers/office/detailmaintenance.php';
                            ...
                            <div class="col-lg-12">
                                <div class="card-box">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <h4 class="m-t-0 header-title"><b>Kode Proyek : <?= $detpro['kodemaint'].$detpro['kodebulan'].$detpro['kodetr'];  ?> - <?= $detpro['noinvoice'];  ?></b></h4>
                                            
                                            <h4 class="m-t-0 header-title"><b><a href="" data-toggle="modal" data-target="#bon-close-modal"> Nilai Maintenance : Rp. <?php echo number_format($detpro['nilaimaint']) ; ?></a></b></h4>
                                            ...
                                            <textarea type="text" class="form-control" id="ketproyek" name="ketmaintenance" ><?= $detpro['status'] ?></textarea>
                                            <button type="submit" class="btn btn-purple waves-effect waves-light" name="updatemaintenance">Update Keterangan</button>
                                            </form>
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <form class="form-horizontal" role="form">
                                                <?php 
                                                    $persen = number_format((($totali/$detpro['nilaimaint'])*100)) ;
                                                    $persenos = number_format(((($detpro['nilaimaint']-$totali)/$detpro['nilaimaint'])*100)) ;
                                                ?>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-7">
                                                      <input type="text" class="form-control" id="inputPassword3" readonly="" value="Rp. <?= number_format($detpro['nilaimaint']-$totali) ;  ?> - <?= $persenos  ?> %">
                                                    </div>
                                                </div>
                                                <div class="form-group">
