...
require '../controllers/office/maintenance.php';
                                    ...
                                    <table id="datatable" class="table table-striped table-bordered">
                                        ...
                                        <tbody>
                                            ...
                                            <?php foreach ($maintenance as $row ) : ?>
                                                ...
                                                <td ><a href="detailmaintenance.php?km=<?= $row["kodemaint"].$row["kodebulan"].$row["kodetr"] ?>" class="text-primary"><?= $row["kodemaint"].$row["kodebulan"].$row["kodetr"] ?></a>
                                                    <br><?= $row["noinvoice"] ; ?>
                                                </td>    
                                                
                                                <td width="10%"; ><?= $row["pekerjaan"] ?></td>
                                                <td><?= $row["outlet"] ?> <br> <?= $row["tempat"] ?></td>
                                                
                                                <td>Rp. <?= "<b>" . number_format($row["nilaimaint"]) . " </b>" ?></td>
