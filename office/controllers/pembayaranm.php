...
if( isset($_POST["tp"]) ) {
    ...
    $pembayaran = query("SELECT * FROM pembayaranpmr WHERE kodekas ='KBMM' AND month(tanggal) = '$tampilkanbulan' AND year(tanggal) ='$tahun' ORDER BY tanggal DESC, id DESC");
    ...
    $pembayaran = query("SELECT * FROM pembayaranpmr WHERE kodekas ='KBMM' ORDER BY tanggal DESC, id DESC");
