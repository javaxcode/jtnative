...
require 'controllers/c_detailkaskecil.php';
                    ...
                    <div class="card-box">
                        ...
                        <form class="form-horizontal group-border-dashed" method="post" action="">
                            <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    <input type="hidden" class="form-control" required name="jam" id="jam" value="<?php date_default_timezone_set('Asia/Jakarta');
                                                                                                                    $date = new DateTime();
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <input type="text" class="form-control" name="jumlah" id="jumlah" required placeholder="0" />
                                </div>
                            </div>
