...
require '../controllers/office/pembayaranm.php';
                            ...
                            <div class="col-lg-7">
                                <div class="card-box">
                                    ...
                                    <div class="dropdown pull-centre">
                                       <button class="btn btn-success waves-effect waves-light" >Pemasukan : Rp </button>
                                       <button class="btn btn-danger waves-effect waves-light" name="outstanding">Pengeluaran : Rp.</button>
                                        ...
                                        <tbody>
                                            ...
                                            <?php foreach ($pembayaran as $row ) : ?>
                                                <tr>
                                                    ...
                                                    <?php //endif ; ?>  -->
                                                    <td width="10%">
                                                        <a href="detailmaintenance.php?km=<?= $row['kodeproyek']?>"><?= $row["kodeproyek"];  ?></a>
                                                    </td>
